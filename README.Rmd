...
The responses vignette demonstrates qsurvey tools for working with survey
responses.
...
object that many other qsurvey functions operate on. 
...
survey's flow and content in a Shiny app, use `render_survey()`. The vignette on
